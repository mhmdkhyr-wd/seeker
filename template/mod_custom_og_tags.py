...
if old.lower() != 'y':
    ...
    with open('template/custom_og_tags/index_temp.html', 'r',encoding='utf-8') as index_temp:
    ...
    with open('template/custom_og_tags/index.html', 'w',encoding='utf-8') as new_index:
