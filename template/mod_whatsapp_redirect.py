...
with open('template/whatsapp_redirect/index_temp.html', 'r',encoding='utf-8') as index_temp:
...
with open('template/whatsapp_redirect/index.html', 'w',encoding='utf-8') as new_index:
